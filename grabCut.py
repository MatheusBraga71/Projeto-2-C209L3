...
class GrabCutGUI(Frame):
    ...
    def iniciaUI(self):
        ...
        self.canvas.image = self.imagem #pra imagem n�o ser removida pelo garbage collector
    ...
    def callbackBotaoPressionadoEmMovimento(self, event):
        ...
        #atualiza o ret�ngulo a ser desenhado
        self.canvas.coords(self.rect, self.startX, self.startY, currentX, currentY)

        #verifica se existe ret�ngulo desenhado
